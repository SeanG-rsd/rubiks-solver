...
export const cubeRanges = [
...

    {
        ...
        max: { red: 255, green: 170, blue: 100, alpha: 255} as Color
    } as Range,

    {
        ...
        max: { red: 255, green: 255, blue: 120, alpha: 255} as Color
    } as Range,

    {
        ...
        max: { red: 110, green: 255, blue: 140, alpha: 255} as Color
    } as Range,

    {
        ...
        max: { red: 100, green: 140, blue: 255, alpha: 255} as Color
    } as Range,

    {
        // High Red, High Green, High Blue (All bright)
        color: "white",
        min: { red: 180, green: 180, blue: 180, alpha: 0} as Color,
